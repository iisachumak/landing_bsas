        ...
        <div class="container text-center mt-2">
            <div class="row">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <FontAwesomeIcon className='icongps' icon={faLocationDot} />Av. Corrientes 4401 (Esquina Pringles) Almagro, Buenos Aires <br />
                ...
                <div class="col-md-6 col-sm-12 mt-3 mb-5">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d14240.972561537972!2d-65.2026133!3d-26.8322179!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2sar!4v1704542878327!5m2!1ses!2sar" width="350" height="300" loading="lazy"></iframe>
                </div>
            </div>
        </div>
    )
